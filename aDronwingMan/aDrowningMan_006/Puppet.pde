class Puppet {
  ...
  void updateArticulations(){
    ...
    /*
    , torsoAngle, chestAngle, neckAngle, headAngle;
    leftShoulderAngle, leftElbowAngle, leftWristAngle, leftHandAngle;
    rightShoulderAngle, rightElbowAngle, rightWristAngle, rightHandAngle;
    leftLegAngle, leftKneeAngle, leftAnkleAngle, leftFeetAngle;
    rightLegAngle, rightKneeAngle, rightAnkleAngle, rightFeetAngle;*/
  }
}
