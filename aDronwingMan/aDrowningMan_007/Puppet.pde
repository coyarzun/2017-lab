class Puppet {
  ...
  void updateArticulations(){
    ...
    neckAngle.setAndNormalizeX(  sin( radians(frameCount+30) ) );
    headAngle.setAndNormalizeX(  sin( radians(frameCount+40) ) );
    ...
    rightLegAngle.setAndNormalizeX(   sin( radians(frameCount-10) ) );
    rightKneeAngle.setAndNormalizeX(  sin( radians(frameCount-20) ) );
    rightAnkleAngle.setAndNormalizeX( sin( radians(frameCount-30) ) );
    rightFeetAngle.setAndNormalizeX(  sin( radians(frameCount-40) ) );
    
    leftShoulderAngle.setAndNormalizeX(   sin( radians(frameCount-10) ) );
    leftElbowAngle.setAndNormalizeX(  sin( radians(frameCount-20) ) );
    leftWristAngle.setAndNormalizeX( sin( radians(frameCount-30) ) );
    leftHandAngle.setAndNormalizeX(  sin( radians(frameCount-40) ) );
