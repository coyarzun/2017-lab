class Puppet {
  ...
  void setAndNormalizeY(){
    ...
    hipsAngle.setAndNormalizeY(  cos( radians(frameCount) ) );
    torsoAngle.setAndNormalizeY( cos( radians(frameCount+10) ) );
    chestAngle.setAndNormalizeY( cos( radians(frameCount+20) ) );
    neckAngle.setAndNormalizeY(  2*cos( radians(frameCount+30) ) );
    headAngle.setAndNormalizeY(  2*cos( radians(frameCount+40) ) );
    
    leftLegAngle.setAndNormalizeY(   cos( radians(frameCount-10) ) );
    leftKneeAngle.setAndNormalizeY(  cos( radians(frameCount-20) ) );
    leftAnkleAngle.setAndNormalizeY( cos( radians(frameCount-30) ) );
    leftFeetAngle.setAndNormalizeY(  cos( radians(frameCount-40) ) );
    
    rightLegAngle.setAndNormalizeY(   sin( radians(frameCount-10) ) );
    rightKneeAngle.setAndNormalizeY(  sin( radians(frameCount-20) ) );
    rightAnkleAngle.setAndNormalizeY( sin( radians(frameCount-30) ) );
    rightFeetAngle.setAndNormalizeY(  sin( radians(frameCount-40) ) );
    
    leftShoulderAngle.setAndNormalizeY(   sin( radians(frameCount-10) ) );
    leftElbowAngle.setAndNormalizeY(  sin( radians(frameCount-20) ) );
    leftWristAngle.setAndNormalizeY( sin( radians(frameCount-30) ) );
    leftHandAngle.setAndNormalizeY(  sin( radians(frameCount-40) ) );
    
    rightShoulderAngle.setAndNormalizeY( cos( radians(frameCount-10) ) );
    rightElbowAngle.setAndNormalizeY(  cos( radians(frameCount-20) ) );
    rightWristAngle.setAndNormalizeY( cos( radians(frameCount-30) ) );
    rightHandAngle.setAndNormalizeY(  cos( radians(frameCount-40) ) );
  ...
  void setAndNormalizeZ(){
    ...
    torsoAngle.setAndNormalizeZ( sin( radians(frameCount+10) ) );
    chestAngle.setAndNormalizeZ( sin( radians(frameCount+20) ) );
    neckAngle.setAndNormalizeZ(  2*sin( radians(frameCount+30) ) );
    headAngle.setAndNormalizeZ(  2*sin( radians(frameCount+40) ) );
    
    leftLegAngle.setAndNormalizeZ(   sin( radians(frameCount-10) ) );
    leftKneeAngle.setAndNormalizeZ(  sin( radians(frameCount-20) ) );
    leftAnkleAngle.setAndNormalizeZ( sin( radians(frameCount-30) ) );
    leftFeetAngle.setAndNormalizeZ(  sin( radians(frameCount-40) ) );
    
    rightLegAngle.setAndNormalizeZ(   cos( radians(frameCount-10) ) );
    rightKneeAngle.setAndNormalizeZ(  cos( radians(frameCount-20) ) );
    rightAnkleAngle.setAndNormalizeZ( cos( radians(frameCount-30) ) );
    rightFeetAngle.setAndNormalizeZ(  cos( radians(frameCount-40) ) );
    
    leftShoulderAngle.setAndNormalizeZ(   cos( radians(frameCount-10) ) );
    leftElbowAngle.setAndNormalizeZ(  cos( radians(frameCount-20) ) );
    leftWristAngle.setAndNormalizeZ( cos( radians(frameCount-30) ) );
    leftHandAngle.setAndNormalizeZ(  cos( radians(frameCount-40) ) );
    
    rightShoulderAngle.setAndNormalizeZ( sin( radians(frameCount-10) ) );
    rightElbowAngle.setAndNormalizeZ(  sin( radians(frameCount-20) ) );
    rightWristAngle.setAndNormalizeZ( sin( radians(frameCount-30) ) );
    rightHandAngle.setAndNormalizeZ(  sin( radians(frameCount-40) ) );
